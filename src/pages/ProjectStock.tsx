        ...
        <div className='grid grid-cols-1 gap-4 mt-8 max-w-3xl mx-auto'>
          <Card>
            ...
            <CardContent className='text-sm leading-relaxed space-y-2'>
              ...
              <p className='opacity-70 text-xs'>Built on a synthetic daily-return series generated from a two-state (calm/volatile) regime model — self-generated for demonstration, so the mechanics and every statistic below are real.</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className='text-sm space-y-2'>
              <ul className='list-disc pl-5 space-y-2 opacity-90'>
                <li>Modeled the underlying series with a <strong>2-state Markov regime</strong> (calm vs. volatile daily vol/drift) rather than a single flat distribution — markets don't have one volatility, they switch between a few.</li>
