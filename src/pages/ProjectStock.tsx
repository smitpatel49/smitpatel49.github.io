...
export default function Page() {
  useHeadMeta({ title: 'Simulating a Buy/Sell Call for a Stock', description: 'Regime-aware block bootstrap over 3,000 paths; VaR/CVaR and a fan chart.', path: '/projects/stock' })
  return (
