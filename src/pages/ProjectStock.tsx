        ...
        <div className='grid grid-cols-1 gap-4 mt-8 max-w-3xl mx-auto'>
          <Card>
            ...
            <CardContent className='text-sm leading-relaxed space-y-2'>
              ...
              <p className='opacity-70 text-xs'>The daily-return series behind it is synthetic, self-generated from a two-state (calm/volatile) regime model for demonstration purposes. The mechanics and every statistic below are real, run against that series.</p>
            </CardContent>
          </Card>
