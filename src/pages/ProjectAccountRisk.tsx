        ...
        <div className='grid grid-cols-1 gap-4 mt-8 max-w-3xl mx-auto'>
          <Card>
            ...
            <CardContent className='text-sm leading-relaxed space-y-2'>
              ...
              <p className='opacity-70 text-xs'>The 640 accounts, their usage history, tickets, and survey scores are synthetic, generated to resemble a mid-size B2B SaaS book of business. There's no real company behind these numbers, but the requirements process, the rule, and every KPI below are computed by actually running that rule against the data, not typed in after the fact.</p>
            </CardContent>
          </Card>
