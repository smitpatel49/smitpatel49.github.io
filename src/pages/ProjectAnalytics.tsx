        ...
        <div className='grid grid-cols-1 gap-4 mt-8 max-w-3xl mx-auto'>
          <Card>
            ...
            <CardContent className='text-sm leading-relaxed space-y-2'>
              ...
              <p className='opacity-70 text-xs'>The dataset behind it is synthetic (2,430 customers, 5,599 orders, and 19,863 funnel events, generated with a Python script that models per-customer retention decay and sequential funnel drop-off), loaded into a real PostgreSQL 16 database. There's no company behind these numbers, but the schema, the queries, and every result in the charts below came from actually running that SQL, not from typing in a plausible-looking figure.</p>
            </CardContent>
          </Card>
