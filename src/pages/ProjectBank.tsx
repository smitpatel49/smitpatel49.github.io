        ...
        <div className='grid grid-cols-1 gap-4 mt-8 max-w-3xl mx-auto'>
          <Card>
            ...
            <CardContent className='text-sm leading-relaxed space-y-2'>
              ...
              <p className='opacity-70 text-xs'>The dataset is synthetic, self-generated to look like the classic bank telemarketing problem, so only the underlying rows are simulated. The schema, the training run, and every metric below are real.</p>
            </CardContent>
          </Card>
