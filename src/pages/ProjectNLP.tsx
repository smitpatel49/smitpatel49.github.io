...
export default function Page() {
  useHeadMeta({ title: 'Support Ticket Routing (NLP)', description: 'TF-IDF baseline vs. a small transformer trained from scratch, with an honest look at where each one wins.', path: '/projects/nlp' })
  return (
