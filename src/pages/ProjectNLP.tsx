        ...
        <div className='grid grid-cols-1 gap-4 mt-8 max-w-3xl mx-auto'>
          <Card>
            ...
            <CardContent className='text-sm leading-relaxed space-y-2'>
              ...
              <p className='opacity-70 text-xs'>The 2,688 tickets are synthetic, generated with combinatorial templates and a deliberate share of blended, cross-category phrasing so the dataset isn't trivially easy. Both models below were actually trained and evaluated on that data; no result here is a placeholder.</p>
            </CardContent>
          </Card>
