...
export default function Page() {
  useHeadMeta({ title: 'Simulating Company Merger/Acquisition', description: '20,000-trial Monte Carlo on deal accretion, with regression-based sensitivity analysis.', path: '/projects/mna' })
  return (
