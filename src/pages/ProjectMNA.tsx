        ...
        <div className='grid grid-cols-1 gap-4 mt-8 max-w-3xl mx-auto'>
          <Card>
            ...
            <CardContent className='text-sm leading-relaxed space-y-2'>
              ...
              <p className='opacity-70 text-xs'>The acquirer and target here are an illustrative profile, not a real transaction, but every number below is a genuine simulation output run against that profile, not a placeholder.</p>
            </CardContent>
          </Card>
