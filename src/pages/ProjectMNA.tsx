  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-white to-neutral-50 dark:from-neutral-950 dark:to-neutral-900 text-neutral-900 dark:text-neutral-100'>
      <div className='section'>
        ...
        <p className='text-center opacity-80 max-w-2xl mx-auto'>20,000-trial Monte Carlo on deal premium, synergies, and financing mix — with sensitivity from standardized regression, not a naive one-at-a-time tornado.</p>
        ...
        <div className='grid grid-cols-1 gap-4 mt-8 max-w-3xl mx-auto'>
          <Card>
            ...
            <CardContent className='text-sm leading-relaxed space-y-2'>
              <p className='opacity-90'>Deal teams almost never get a single-number answer to "will this be accretive?" — the honest answer is a distribution, because the premium paid, synergy realization, and financing mix are all still being negotiated. This models that distribution directly instead of pretending one base case is the forecast.</p>
              <p className='opacity-70 text-xs'>Uses an illustrative acquirer/target profile (not a real transaction) so every number below is a genuine simulation output, not a placeholder.</p>
            </CardContent>
          </Card>
